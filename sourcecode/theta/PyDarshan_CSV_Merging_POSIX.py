...
def load_csv_report(path_to_csv_file: Path):
    try:
        darshan_report = pd.read_csv(path_to_csv_file)
        darshan_report["file"] = str(path_to_csv_file)
        return darshan_report
...
if __name__ == "__main__":
    ...
    combined_df.to_csv(dataset_dir.joinpath(output_csv_name + ".csv"), index=False)
